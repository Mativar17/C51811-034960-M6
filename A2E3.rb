...
while respuesta == 1
    ...
    while salario >= 100000 && salario <=300000
        1.time {puts "Existen #{contador_personas} personas con salario entre $100.000 y $300.000"}
    end

    while salario > 300000 && salario <= 500000
        1.time {puts "Existen #{contador_personas} personas con salario entre $300.001 y $500.000"}
    end
    puts "---------------------------"
end
